	...
	for k,v in pairs(Config.Items) do
		ESX.RegisterUsableItem(k, function(source)
			...
			if v.type == "food" then
				...
				TriggerClientEvent('esx_basicneeds:onUse', source, v.type, v.prop, v.anim, v.pos or Config.DefaultPos.FOOD)
			...
			elseif v.type == "drink" then
				...
				TriggerClientEvent('esx_basicneeds:onUse', source, v.type, v.prop, v.anim, v.pos or Config.DefaultPos.DRINK)
